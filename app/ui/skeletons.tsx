...
export function CardSkeleton() {
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center truncate rounded-xl bg-slate-100 px-4 py-8">
  ...
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className="rounded-xl bg-gray-200 p-4">
        <div className="mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-slate-100 p-4 sm:grid-cols-13 md:gap-4" />
